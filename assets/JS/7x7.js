...
sizes.innerHTML = "<div><p class='frame-size'>Frame size:</p><p class='frame-size'>7x7</p></div>"
...
function animate7x7(){
    ...
    function orderChange(item1, item2){
       ...
       }else if([...gameFrame.childNodes].indexOf(item2) === [...gameFrame.childNodes].indexOf(item1) + 7){
        gameFrame.replaceChild(item1, item2)
        gameFrame.insertBefore(item2, item1.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling)
       }else if([...gameFrame.childNodes].indexOf(item2) === [...gameFrame.children].indexOf(item1) - 7){
        gameFrame.replaceChild(item1, item2)
        gameFrame.insertBefore(item2, item1.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling)
       }  
       curtain.style.display = 'none';
       combinationChecker(7)
    }
    ...
    gameFrame.childNodes.forEach((fragment, index)=>{
        fragment.addEventListener('click', function eventListener() {
            ...
            }else if(fragment.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling && fragment.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.hasAttribute('id')){
                fragment.style.transition = 'all 0.4s ease-out';
                fragment.style.transform = 'translateY(105%)'
                curtain.style.display = 'block'
                setTimeout(()=>{
                    fragment.style.transform = 'translateY(0%)'
                    orderChange(fragment, fragment.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling)
                    fragment.addEventListener('click', eventListener)  
                }, 1000)

            }else if(fragment.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling && fragment.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.hasAttribute('id')){
                fragment.style.transition = 'all 0.4s ease-out';
                fragment.style.transform = 'translateY(-105%)'
                curtain.style.display = 'block'
                setTimeout(()=>{
                    fragment.style.transition = 'none'
                    fragment.style.transform = 'translateY(0%)'
                    orderChange(fragment, fragment.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling)
                    fragment.addEventListener('click', eventListener)  
                }, 1000)
...
function puzzle7x7(){
    ...
    fragment45, fragment46, fragment47, fragment48, fragment49,];
    let min = 0;
